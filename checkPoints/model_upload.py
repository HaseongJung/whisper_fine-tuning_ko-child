...
def loadDatasetLocal(dataset: str):
    dataset = load_from_disk(dataset + dataset_name)
...
if __name__ == "__main__":
    ...
    JW_token = "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"
    HS_token = "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"
    login(token=JW_token)
    ...
    # load model
    model_checkpoint = "whisper-small_child-50k2/checkpoint-5000"
    feature_extractor = WhisperFeatureExtractor.from_pretrained(model_checkpoint)
    tokenizer = WhisperTokenizer.from_pretrained("whisper-small_child-50k2")
    processor = WhisperProcessor.from_pretrained("whisper-small_child-50k2")
