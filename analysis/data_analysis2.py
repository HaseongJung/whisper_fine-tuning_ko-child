...
if __name__ == '__main__':
    ...
    # audio files load
    audio_dir = "C:\\stt\\data\\명령어 음성(소아, 유아)\\Training\\audio\\"
    wav_files = []
    ...
    # json files load
    label_dir = "C:\\stt\\data\\명령어 음성(소아, 유아)\\Training\\label\\"
    json_files = []
    ...
    # 10000씩 하자!
    start, end = 50000, 110000 #len(wav_files)   # start, end 지정
    step = 30000                # step 지정 (파일 몇개씩 preprocessing할건지)    
    num1 = start
    num2 = num1+step
    while (True):
        if num1 >= end:
