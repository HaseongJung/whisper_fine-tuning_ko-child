...
if __name__ == '__main__':
    ...
    # load dataset
     ## Train dataset
    train_dataset_name = "data/encoded_dataset_resampling/korean-child-command-voice_train-0-50000"
    dataset = loadDatasetFromLocal(train_dataset_name)
    print(f"{dataset}\nTrain dataset load complete")
     ## Test dataset
    test_dataset_name = "haseong8012/child-10k-adult-6k_for_test"
    ...
    # repo_name = f"{model_checkpoint.split('/')[1]}_{train_dataset_name.split('/')[-1]}" 
